> **Reference doc.** This describes the product workflow state machine. The workflow is driven by individual skills (task-plan, task-act, etc.); this document is the human-readable overview.

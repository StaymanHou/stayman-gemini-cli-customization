...
echo
echo "Next steps:"
echo "  1. Ensure \$TELEGRAM_BOT_TOKEN and \$TELEGRAM_CHAT_ID are exported in your shell"
echo "     (or configured in ~/.gemini/settings.json under \"env\") so notify-human works."
